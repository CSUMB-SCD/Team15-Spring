...
public class ElectronicsDbSender implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ProductInfo pi1 = new ProductInfo(1,5,"MacBook Pro",
        ...
        ProductInfo pi2 = new ProductInfo(2,7,"AirPods",
